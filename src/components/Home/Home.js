...
class Home extends React.Component {
  render() {
    return (
      <div className='home'>
        <PreviewAbout />
        <ProjectSection className='featured-project' title='Pay Me Connor'  imageSrc='https://media.giphy.com/media/yvXfCrSYDs0wanhe9i/giphy.gif' direction='left' repoLink='https://github.com/Pleeper228/pay-me-connor-client'>
